        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{enumerate}
                ...
                \uncover<2>{
                    ...
                    \end{equation*}
                    where~$\epsilon(x) \sim N(0, \sigma^2)$,~$\sigma = 10^{-2}$.
                }
            \end{enumerate}
        \end{column}
        \begin{column}{0.5\textwidth}
...
\begin{frame}
	...
	\begin{enumerate}
        \item All the experiments are based on
...
\begin{frame}
	...
	We make the following comparison on \alert{unconstrained} problems.
...
\begin{frame}
    ...
    \begin{enumerate}[<+->]
        \item \alert{linearly constrained} problems,
    ...
    \begin{center}
        \only<1>{\drawperformanceprofiles{{"COBYQA","LINCOA","COBYLA"}}{plain-1-50-perf-cobyla-cobyqa-lincoa-nl.csv}{4}}%
        \only<2>{\drawperformanceprofiles{{"COBYQA","LINCOA","COBYLA"}}{plain-1-50-perf-cobyla-cobyqa-lincoa-nl-bounds.csv}{4}}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item It has been downloaded more than \num{40000} times.
            \item It is included in the GEMSEO package.
        \end{enumerate}
        \item An investigation of the~\alert{$\Lambda$-poisedness} of a particular set.
        \item New developments in the \alert{SQP method}.
        \item Our new DFO method \alert{COBYQA}.
        \begin{enumerate}
            \item It will be included in the PDFO and GEMSEO packages.
            \item Numerical experiments show that COBYQA is a \alert{good successor} for COBYLA.
            \item Fran{\c{c}}ois Gallard from IRT Saint-Exup{\'{e}}ry sent us (by email)
        \end{enumerate}
    \end{enumerate}
