...
\begin{frame}
    ...
    \begin{center}
        \drawperformanceprofiles{{"COBYQA","BOBYQA","COBYLA"}}{noisy-1-50-2-perf-bobyqa-cobyla-cobyqa-b.csv}{2}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
        \drawperformanceprofiles{{"COBYQA","COBYLA"}}{noisy-1-50-2-perf-cobyla-cobyqa-qo.csv}{2}
    \end{center}
\end{frame}
