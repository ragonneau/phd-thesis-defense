...
\begin{frame}
    ...
    \begin{enumerate}
        \item The mathematics of \only<1>{the \textcolor{BurntOrange}{\textbf{standard}}}\only<2>{our \textcolor{MidnightBlue}{\textbf{new}}} approach are as follows.
...
\begin{frame}
    ...
    \begin{enumerate}[<+->]
        ...
        \item adding \alert{noise} to~$\obj$, with~$\sigma = 10^{-6}$.
    \end{enumerate}
